...
const {
	ValidateProfileUpdateMiddleware, ValidateSignupMiddleware,ValidateUpdatePassMiddleware
...
//update passwords
router.post("/user/update-pass/:e_id",ValidateUpdatePassMiddleware, async (req, res) => {
